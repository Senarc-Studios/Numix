...
class moderation(commands.Cog, name='Moderation'):
	...
	@commands.command(description="Clears the specified amount of messages", name="clear")
	@commands.guild_only()
	...
	@commands.command(description="Bans a mentioned user.", name="ban")
	@commands.guild_only()
	...
	@commands.command(description="Kicks a mentioned user.", name="kick")
	@commands.guild_only()
	@commands.has_permissions(kick_members=True)
	...
	@commands.command(description="Shows all the warning a user has.")
	@commands.guild_only()
	@commands.has_permissions(manage_messages=True)
